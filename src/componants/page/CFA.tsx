...
function CFA() {
  return (
    ...
    <div className="flex gap-1 max-sm:flex-col max-sm:gap-5 max-sm:items-center">
                ...
                <Button variant={"default"} className='mr-8 max-sm:m-0 bg-[#473BF0]/20 text-[#473BF0] p-13 py-7 text-md flex gap-9 hover:bg-[#473bf0d5]/20  max-xl:gap-2' size={"lg"}> Learn More <ArrowRight size={30} className='text-xl' /></Button>
        <Button variant={"default"} className='mr-8 max-sm:m-0 bg-[#473BF0] p-13 py-7 flex gap-9 text-md max-xl:gap-2 hover:bg-[#473bf0d5]' size={"lg"}> Get it Now <ArrowRight size={20} className='text-xl' /></Button>
